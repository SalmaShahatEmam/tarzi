                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">{{ __('models.edit_order') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">{{ __('models.edit_order') }}</h2>
                                </div>
                                <div class="card-body">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="order_type" id="order_type">
                                                        <option value="">اختر</option>
                                                        <option value="rafa"
                                                            {{ $order->order_type == 'rafa' ? 'selected' : '' }}>
                                                            {{ __('models.rafa') }}</option>
                                                        <option value="print"
                                                            {{ $order->order_type == 'print' ? 'selected' : '' }}>
                                                            {{ __('models.print') }}</option>
                                                    </select>
                                                    @error('order_type')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
